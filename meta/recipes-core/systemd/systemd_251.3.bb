...
PACKAGECONFIG_remove_mipsarch = "seccomp"
...
SUMMARY_libsystemd-shared = "Systemd shared library"
...
USERADD_PARAM_${PN}-journal-gatewayd = "--system -d / -M --shell /sbin/nologin systemd-journal-gateway"
...
INSANE_SKIP_libsystemd-shared += "libdir"

FILES_libsystemd-shared = "${rootlibexecdir}/systemd/libsystemd-shared*.so"
